...
- ✅ Includes all blog posts in `blog-metadata.ts` (currently 130)
...
- ✅ All blog posts have SEO metadata in `blog-metadata.ts`
...
- **Total Pages**: 136 (6 main routes including `/blog` index + 130 blog posts; see `blog-metadata.ts`)
- **Blog Posts**: 130 (all with unique SEO metadata in `blog-metadata.ts`)
