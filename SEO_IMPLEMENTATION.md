...
- ✅ Includes all blog posts in `blog-metadata.ts` (currently 140)
...
- **Total Pages**: 146 (6 main routes including `/blog` index + 140 blog posts; see `blog-metadata.ts`)
- **Blog Posts**: 140 (all with unique SEO metadata in `blog-metadata.ts`)
