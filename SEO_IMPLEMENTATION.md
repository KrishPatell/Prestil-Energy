...
- ✅ Includes all blog posts in `blog-metadata.ts` (currently 120)
...
- **Total Pages**: 126 (6 main routes including `/blog` index + 120 blog posts; see `blog-metadata.ts`)
- **Blog Posts**: 120 (all with unique SEO metadata in `blog-metadata.ts`)
