...
export default function EspWinterizationCondensationControlFieldChecklist() {
  return (
    <>
      <BlogHero
        title="ESP Winterization and Condensation Control Field Checklist"
        image={heroImage}
      ...
      >
        <div className="space-y-8">
          <h2>Exposure risks</h2>
          <p>Cold weather and condensation can damage insulation systems, junction boxes, and surface power gear.</p>
          <h2>Checklist scope</h2>
          <p>Cover heaters, drains, breather management, and enclosure integrity for critical ESP skids.</p>
          <h2>Seasonal readiness</h2>
          <p>Schedule pre-season verification and post-storm inspections with assigned owners.</p>
          <h2>Conclusion</h2>
