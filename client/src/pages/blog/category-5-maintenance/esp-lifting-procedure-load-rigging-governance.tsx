...
export default function EspLiftingProcedureLoadRiggingGovernance() {
  return (
    <>
      <BlogHero
        title="ESP Lifting Procedure and Load Rigging Governance"
        image={heroImage}
      ...
      >
        <div className="space-y-8">
          <h2>Risk context</h2>
          <p>Improper lifting and rigging can damage shafts, couplings, and cable terminations before installation.</p>
          <h2>Governance elements</h2>
          <p>Certified rigging plans, weight verification, and single point of command for crane operations.</p>
          <h2>Documentation</h2>
          <p>Photo log and checklist sign-off for each critical lift milestone.</p>
          <h2>Conclusion</h2>
