...
export default function RigScheduleSlippageEspSparesBufferingStrategy() {
  return (
    <>
      <BlogHero
      ...
      <BlogLayout
        ...
        relatedPosts={[
          { slug: "strategic-spares-planning-for-esp-under-sanctions", title: "Strategic Spares Planning Under Sanctions" },
          { slug: "esp-rigless-intervention-options", title: "ESP Rigless Intervention Options" },
          { slug: "conflict-zone-workover-window-optimization-for-esp", title: "Conflict-Zone Workover Window Optimization" }
        ]}
      ...
      >
        <div className="space-y-8">
          ...
          <p>Rig queues slip; buffering should reflect lead time variance, not only average delivery.</p>
          <h2>Buffer sizing</h2>
          <p>Weight criticality, substitution options, and storage constraints when setting min/max levels.</p>
          <h2>Coordination</h2>
          <p>Align maintenance windows with logistics milestones to avoid idle equipment.</p>
          <h2>Conclusion</h2>
