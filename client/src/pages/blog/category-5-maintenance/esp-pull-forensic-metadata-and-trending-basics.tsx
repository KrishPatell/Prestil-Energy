...
export default function EspPullForensicMetadataAndTrendingBasics() {
  return (
    <>
      <BlogHero
      ...
      >
        <div className="space-y-8">
          <h2>Metadata essentials</h2>
          <p>Capture run hours, fluid history, alarm counts, and component serials in a structured pull sheet.</p>
          <h2>Trending value</h2>
          <p>Fleet-level comparisons reveal systemic issues versus one-off anomalies.</p>
          <h2>Quality control</h2>
          <p>Photos and dimensional checks should link to the same record ID for traceability.</p>
          <h2>Conclusion</h2>
