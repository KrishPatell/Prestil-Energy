...
export default function EspWorkoverReadinessChecklist72HourWindow() {
  return (
    <>
      <BlogHero
        title="ESP Workover Readiness Checklist: 72-Hour Window"
        image={heroImage}
      ...
      <BlogLayout
        ...
        relatedPosts={[
          ...
          { slug: "rig-schedule-slippage-esp-spares-buffering-strategy", title: "Rig Schedule Slippage and ESP Spares Buffering Strategy" }
        ]}
      ...
      >
        <div className="space-y-8">
          <h2>72-hour objective</h2>
          <p>Use the final pre-workover window to eliminate avoidable delays and safety gaps.</p>
          <h2>Checklist domains</h2>
          <p>Cover permits, spares, lifting plans, electrical isolation, and communication roles.</p>
          <h2>Go/no-go gate</h2>
          <p>Require sign-off from operations, maintenance, and HSE before rig-up starts.</p>
          <h2>Conclusion</h2>
