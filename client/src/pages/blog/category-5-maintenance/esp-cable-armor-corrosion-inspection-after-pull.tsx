...
export default function EspCableArmorCorrosionInspectionAfterPull() {
  return (
    <>
      <BlogHero
        title="ESP Cable Armor Corrosion Inspection After Pull"
        image={heroImage}
      ...
      <BlogLayout
        ...
        relatedPosts={[
          ...
          { slug: "esp-cables-guide", title: "ESP Cables Guide" },
      ...
      >
        <div className="space-y-8">
          <h2>What armor tells you</h2>
          <p>Armor corrosion, crushing, and galvanic attack record well chemistry, mechanical abuse, and clamp practice. Ignoring armor on pull wastes the cheapest forensic evidence on the string.</p>
          <h2>Inspection method</h2>
          <p>Photograph full length, mark depth-correlated damage, and sample pitting versus uniform loss. Separate installation damage from downhole corrosion.</p>
          <h2>Disposition</h2>
          <p>Do not reuse armor with through-pitting or crushed conductors. Feed findings into next-run cable spec, clamp plan, and chemical program.</p>
          <h2>Conclusion</h2>
