...
export default function EspCommissioningVibrationBaselineAcceptance() {
  return (
    <>
      <BlogHero
      ...
      >
        <div className="space-y-8">
          ...
          <p>Define reference planes, sensor mounting, and band-limited levels agreed before startup.</p>
          <h2>Baseline capture</h2>
          <p>Record stable-rate spectra at multiple operating points for later comparison.</p>
          <h2>Documentation</h2>
          <p>Store baselines in the CMMS with well ID, equipment serials, and fluid context.</p>
          <h2>Conclusion</h2>
