...
export default function EspPreservationPlanForLongLeadSparesStorage() {
  return (
    <>
      <BlogHero
      ...
      >
        <div className="space-y-8">
          <h2>Preservation problem</h2>
          <p>Long-lead spares can degrade in storage and fail early if preservation routines are weak.</p>
          <h2>Plan essentials</h2>
          <p>Define humidity control, inspection intervals, rotation logic, and recordkeeping standards.</p>
          <h2>Release readiness</h2>
          <p>Require pre-install inspection and electrical checks before dispatch to field.</p>
          <h2>Conclusion</h2>
