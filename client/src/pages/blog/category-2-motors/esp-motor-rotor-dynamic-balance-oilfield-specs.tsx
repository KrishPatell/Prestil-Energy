...
export default function EspMotorRotorDynamicBalanceOilfieldSpecs() {
  return (
    <>
      <BlogHero
      ...
      <BlogLayout
        ...
        relatedPosts={[
          { slug: "esp-motor-vibration-monitoring", title: "ESP Motor Vibration Monitoring" },
          { slug: "esp-motor-thrust-bearing-systems", title: "ESP Motor Thrust Bearing Systems" },
          { slug: "motor-efficiency-ie-standards-esp", title: "Motor Efficiency and IE Standards for ESP" }
        ]}
      ...
      >
        <div className="space-y-8">
          <h2>Balance quality levels</h2>
          <p>Specify residual unbalance limits compatible with downhole speed range and bearing load capacity.</p>
          <h2>Shop vs field context</h2>
          <p>Balance certificates should map to assembled rotor stacks including adapters used in the well.</p>
          <h2>Operational follow-up</h2>
          <p>Baseline vibration after commissioning helps detect balance degradation or mounting issues.</p>
          <h2>Conclusion</h2>
