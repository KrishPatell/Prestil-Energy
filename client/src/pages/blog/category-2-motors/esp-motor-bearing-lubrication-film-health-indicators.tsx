...
export default function EspMotorBearingLubricationFilmHealthIndicators() {
  return (
    <>
      <BlogHero
        title="ESP Motor Bearing Lubrication Film Health Indicators"
        image={heroImage}
        category="motors"
        date="April 2026"
        readTime={10}
      ...
      >
        <div className="space-y-8">
          <h2>Film health concept</h2>
          <p>Bearing films depend on speed, load, temperature, and lubricant condition; degradation often precedes hard failure.</p>
          <h2>Observable indicators</h2>
          <p>Pair vibration trends with temperature and current stability to distinguish film issues from electrical faults.</p>
          <h2>Response playbook</h2>
          <p>Define derate steps and pull triggers when multiple indicators align.</p>
          <h2>Conclusion</h2>
