...
export default function DownholeTemperatureDeratingEspMotorLoadPlans() {
  return (
    <>
      <BlogHero
      ...
      >
        <div className="space-y-8">
          <h2>Why derating matters</h2>
          <p>Insulation life and bearing lubrication are strongly temperature-dependent; load plans must reflect hottest credible producing states.</p>
          <h2>Building load envelopes</h2>
          <p>Combine sensor TDH, coolant jacket performance, and speed to ensure continuous operation inside thermal class.</p>
          <h2>Field validation</h2>
          <p>Compare modeled winding temperature rise to trends; adjust rate targets when cooling margin shrinks.</p>
          <h2>Conclusion</h2>
