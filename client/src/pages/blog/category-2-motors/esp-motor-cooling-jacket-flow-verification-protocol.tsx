...
export default function EspMotorCoolingJacketFlowVerificationProtocol() {
  return (
    <>
      <BlogHero
        title="ESP Motor Cooling Jacket Flow Verification Protocol"
        image={heroImage}
        category="motors"
        date="April 2026"
        readTime={10}
      ...
      <BlogLayout
        ...
        relatedPosts={[
          { slug: "submersible-motor-cooling-jacket-design", title: "Submersible Motor Cooling Jacket Design" },
      ...
      >
        <div className="space-y-8">
          <h2>Cooling dependency</h2>
          <p>Motor thermal performance depends on reliable jacket flow and annulus conditions around the string.</p>
          <h2>Verification protocol</h2>
          <p>Define pre-run and periodic checks for flow path integrity and restriction indicators.</p>
          <h2>Operational response</h2>
          <p>If cooling margin shrinks, adjust load envelopes and schedule inspection before insulation damage.</p>
          <h2>Conclusion</h2>
