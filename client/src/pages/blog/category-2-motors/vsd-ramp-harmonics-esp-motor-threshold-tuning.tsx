...
export default function VsdRampHarmonicsEspMotorThresholdTuning() {
  return (
    <>
      <BlogHero
      ...
      <BlogLayout
        ...
        relatedPosts={[
          ...
          { slug: "power-grid-instability-motor-selection-esp", title: "Power Grid Instability and ESP Motor Selection" },
      ...
      >
        <div className="space-y-8">
          <h2>Ramp profile goals</h2>
          <p>Smooth acceleration limits inrush and mechanical shock while still reaching operating points within production targets.</p>
          <h2>Harmonic considerations</h2>
          <p>Filter and carrier settings influence heating and torque ripple; tune with vendor guidance and MCSA baselines.</p>
          <h2>Alarm thresholds</h2>
          <p>Pair electrical alarms with intake and vibration context to avoid nuisance trips during grid disturbances.</p>
          <h2>Conclusion</h2>
