...
export default function EspMotorThermalRunawayPreventionUnderCycling() {
  return (
    <>
      <BlogHero
        title="ESP Motor Thermal Runaway Prevention Under Cycling"
        image={heroImage}
        category="motors"
        date="April 2026"
        readTime={10}
      ...
      <BlogLayout
        ...
        relatedPosts={[
          { slug: "motor-thermal-management", title: "Motor Thermal Management for ESP" },
          { slug: "esp-motor-startup-current-cap-testing-protocol", title: "ESP Motor Startup Current Cap Testing Protocol" },
          { slug: "downhole-temperature-derating-esp-motor-load-plans", title: "Downhole Temperature Derating for ESP Motor Load Plans" }
        ]}
      ...
      >
        <div className="space-y-8">
          <h2>Cycling hazards</h2>
          <p>Frequent starts and stops can accumulate heat faster than the motor can dissipate under downhole constraints.</p>
          <h2>Prevention controls</h2>
          <p>Use minimum off-time rules, staged ramp profiles, and thermal alarms tied to realistic cooling recovery.</p>
          <h2>Field governance</h2>
          <p>Audit cycling behavior weekly and enforce lockouts for repeated thermal excursions.</p>
          <h2>Conclusion</h2>
