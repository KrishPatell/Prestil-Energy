...
export default function EspMotorGroundFaultTrendResponsePlaybook() {
  return (
    <>
      <BlogHero
        title="ESP Motor Ground Fault Trend Response Playbook"
        image={heroImage}
        category="motors"
        date="April 2026"
        readTime={10}
      ...
      >
        <div className="space-y-8">
          ...
          <p>Ground-fault trends need context from load changes and moisture events to avoid false urgency.</p>
          <h2>Response tiers</h2>
          <p>Define watch, caution, and action thresholds with corresponding diagnostic steps.</p>
          <h2>Escalation discipline</h2>
          <p>Ensure each threshold has ownership, timing, and fallback action paths.</p>
          <h2>Conclusion</h2>
