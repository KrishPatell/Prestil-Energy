...
export default function LowHeadingFluidGasBreakoutAtEspIntake() {
  return (
    <>
      <BlogHero
      ...
      <BlogLayout
        ...
        relatedPosts={[
          { slug: "gas-fluid-properties-separator-design", title: "Gas Fluid Properties and Separator Design" },
      ...
      >
        <div className="space-y-8">
          <h2>Mechanism</h2>
          <p>Reduced hydrostatic gradient increases breakout risk near the intake, changing gas volume fraction quickly.</p>
          <h2>Design responses</h2>
          <p>Revisit intake depth, separator selection, and choke strategy to maintain adequate subcooling where applicable.</p>
          <h2>Field diagnostics</h2>
          <p>Correlate intake pressure steps with GOR trends and pump head to distinguish breakout from mechanical issues.</p>
          <h2>Conclusion</h2>
