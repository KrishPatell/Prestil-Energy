...
export default function EspIntakeGasFractionStabilityKpis() {
  return (
    <>
      <BlogHero
      ...
      >
        <div className="space-y-8">
          <h2>Defining KPIs</h2>
          <p>Track rolling averages and variability of intake gas fraction alongside pump head metrics.</p>
          <h2>Stability vs efficiency</h2>
          <p>Stable separation enables steadier BEP operation; instability often precedes gas locking symptoms.</p>
          <h2>Instrumentation placement</h2>
          <p>Use consistent gauge references and calibration windows so KPIs are comparable across wells.</p>
          <h2>Conclusion</h2>
