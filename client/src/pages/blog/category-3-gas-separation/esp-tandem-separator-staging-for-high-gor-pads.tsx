...
export default function EspTandemSeparatorStagingForHighGorPads() {
  return (
    <>
      <BlogHero
        title="ESP Tandem Separator Staging for High-GOR Pads"
        image={heroImage}
      ...
      <BlogLayout
        ...
        relatedPosts={[
          { slug: "gas-separator-sizing", title: "Gas Separator Sizing" },
          { slug: "high-gor-esp-fluid-handling", title: "High-GOR ESP Fluid Handling" },
          { slug: "rotary-gas-separators", title: "Rotary Gas Separators" }
        ]}
      ...
      >
        <div className="space-y-8">
          <h2>When one separator is not enough</h2>
          <p>High-GOR pads can exceed single-separator capacity during slug peaks. Tandem staging shares load and gives the pump a more stable free-gas fraction.</p>
          <h2>Staging rules</h2>
          <p>Size the first unit for peak slug, the second for residual gas at the planned rate. Confirm that pressure drop across both units still leaves NPSH margin.</p>
          <h2>Operations</h2>
          <p>Define bypass governance so operators do not isolate one unit without updating rate and VSD limits.</p>
          <h2>Conclusion</h2>
