...
export default function Co2RichAssociatedGasEspIntakeMarginPlanning() {
  return (
    <>
      <BlogHero
        title="CO2-Rich Associated Gas: ESP Intake Margin Planning"
        image={heroImage}
      ...
      >
        <div className="space-y-8">
          <h2>Property shifts</h2>
          <p>CO2-rich gas changes compressibility and phase behavior, affecting separator performance and pump margin.</p>
          <h2>Margin planning</h2>
          <p>Model worst-case fractions at intake using representative PVT and operating pressure paths.</p>
          <h2>Mitigation levers</h2>
          <p>Coordinate separation, drawdown, and rate caps to protect the first stage.</p>
          <h2>Conclusion</h2>
