...
export default function EspGasLockNearMissInvestigationTemplate() {
  return (
    <>
      <BlogHero
      ...
      >
        <div className="space-y-8">
          <h2>Near-miss value</h2>
          <p>Near-miss reviews reveal process weaknesses before a full gas-lock shutdown occurs.</p>
          <h2>Investigation template</h2>
          <p>Capture timeline, operating state, separator status, and control actions in a standardized format.</p>
          <h2>Corrective actions</h2>
          <p>Convert findings into alarm tuning, operating envelopes, and operator playbooks.</p>
          <h2>Conclusion</h2>
