...
export default function EspSpareCompatibilityMatrixDigitalControl() {
  return (
    <>
      <BlogHero
        title="ESP Spare Compatibility Matrix for Digital Control"
        image={heroImage}
      ...
      >
        <div className="space-y-8">
          ...
          <p>Digital control upgrades can break spare interchangeability if compatibility is undocumented.</p>
          <h2>Matrix design</h2>
          <p>Map hardware, firmware, and parameter dependencies for every critical spare family.</p>
          <h2>Change control</h2>
          <p>Require matrix validation as part of MOC before deploying new revisions.</p>
          <h2>Conclusion</h2>
