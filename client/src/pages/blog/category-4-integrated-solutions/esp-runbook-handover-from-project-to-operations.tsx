...
export default function EspRunbookHandoverFromProjectToOperations() {
  return (
    <>
      <BlogHero
        title="ESP Runbook Handover from Project to Operations"
        image={heroImage}
      ...
      >
        <div className="space-y-8">
          <h2>Handover gaps</h2>
          <p>Projects often leave operations without alarm context, setpoint rationale, and vendor escalation paths.</p>
          <h2>Runbook contents</h2>
          <p>Include operating envelopes, trip matrices, spare lists, and known limitations from commissioning.</p>
          <h2>Acceptance criteria</h2>
          <p>Operations sign-off should require successful tabletop drills on top failure scenarios.</p>
          <h2>Conclusion</h2>
