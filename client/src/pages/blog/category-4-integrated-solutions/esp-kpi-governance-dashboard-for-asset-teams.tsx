...
export default function EspKpiGovernanceDashboardForAssetTeams() {
  return (
    <>
      <BlogHero
        title="ESP KPI Governance Dashboard for Asset Teams"
        image={heroImage}
      ...
      >
        <div className="space-y-8">
          <h2>Governance intent</h2>
          <p>A KPI dashboard should enforce consistent operational decisions, not just display trends.</p>
          <h2>Metric tiers</h2>
          <p>Separate strategic KPIs, daily control indicators, and incident triggers with clear ownership.</p>
          <h2>Decision cadence</h2>
          <p>Run weekly reviews that tie KPI movement to specific operating and maintenance actions.</p>
          <h2>Conclusion</h2>
