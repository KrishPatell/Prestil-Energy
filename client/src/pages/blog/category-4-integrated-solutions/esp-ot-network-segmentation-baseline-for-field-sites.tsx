...
export default function EspOtNetworkSegmentationBaselineForFieldSites() {
  return (
    <>
      <BlogHero
        title="ESP OT Network Segmentation Baseline for Field Sites"
        image={heroImage}
      ...
      >
        <div className="space-y-8">
          <h2>Segmentation purpose</h2>
          <p>Separate ESP control paths from general IT to reduce lateral movement during incidents.</p>
          <h2>Baseline zones</h2>
          <p>Define zones for RTU, historian, operator clients, and vendor remote access with documented rules.</p>
          <h2>Operational maintenance</h2>
          <p>Keep firewall rules and asset inventories current after every change window.</p>
          <h2>Conclusion</h2>
