...
export default function EspDailyOperationsHandoverLogTemplate() {
  return (
    <>
      <BlogHero
        title="ESP Daily Operations Handover Log Template"
        image={heroImage}
      ...
      <BlogLayout
        ...
        relatedPosts={[
          ...
          { slug: "esp-control-room-alarm-rationalization-for-multiwell-pads", title: "ESP Control Room Alarm Rationalization for Multiwell Pads" },
      ...
      >
        <div className="space-y-8">
          <h2>Handover gaps</h2>
          <p>Shift changes lose context when alarms, constraints, and pending actions are not captured consistently.</p>
          <h2>Template structure</h2>
          <p>Include well status, active alarms, setpoint changes, and open maintenance actions in one log.</p>
          <h2>Quality checks</h2>
          <p>Supervisors review incomplete handovers daily to prevent repeated incidents.</p>
          <h2>Conclusion</h2>
