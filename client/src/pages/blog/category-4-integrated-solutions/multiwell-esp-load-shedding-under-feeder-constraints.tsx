...
export default function MultiwellEspLoadSheddingUnderFeederConstraints() {
  return (
    <>
      <BlogHero
        title="Multiwell ESP Load Shedding Under Feeder Constraints"
        image={heroImage}
      ...
      <BlogLayout
        ...
        relatedPosts={[
          ...
          { slug: "esp-kpi-governance-dashboard-for-asset-teams", title: "ESP KPI Governance Dashboard for Asset Teams" }
        ]}
      ...
      >
        <div className="space-y-8">
          <h2>Feeder reality</h2>
          <p>Pads often share a constrained feeder. Simultaneous ESP starts or high-rate ramps can trip upstream protection and take the whole pad down.</p>
          <h2>Shedding logic</h2>
          <p>Rank wells by production consequence and restart difficulty. Shed or stagger the lowest-priority loads first, and never restart all strings at once after a feeder event.</p>
          <h2>Coordination</h2>
          <p>Align shedding with utility or generator limits, VSD inrush, and wellbore restart procedures so production recovery is planned, not chaotic.</p>
          <h2>Conclusion</h2>
