...
export default function EspIntakeDepthAdjustmentUnderVariableDrawdown() {
  return (
    <>
      <BlogHero
      ...
      <BlogLayout
        ...
        relatedPosts={[
          ...
          { slug: "multiphase-intake-conditioning-before-esp-stages", title: "Multiphase Intake Conditioning Before ESP Stages" } ,
      ...
      >
        <div className="space-y-8">
          <h2>Variable drawdown challenge</h2>
          <p>Rapid drawdown shifts change intake pressure margin and can move pumps into unstable gas-handling conditions.</p>
          <h2>Depth adjustment criteria</h2>
          <p>Use reservoir response, GOR behavior, and intervention cost to justify depth changes instead of fixed rules.</p>
          <h2>Verification after changes</h2>
          <p>Re-baseline intake pressure and current behavior after depth updates to confirm stability improvements.</p>
          <h2>Conclusion</h2>
