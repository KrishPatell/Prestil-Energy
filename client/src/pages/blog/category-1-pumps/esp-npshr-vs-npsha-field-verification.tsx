...
export default function EspNpshrVsNpshaFieldVerification() {
  return (
    <>
      <BlogHero
      ...
      >
        <div className="space-y-8">
          <h2>Why NPSH margin matters</h2>
          <p>Manufacturers publish NPSHR curves; the field must prove NPSHA across the operating envelope, including transient choke changes.</p>
          <h2>Field verification steps</h2>
          <p>Align gauge depth, fluid PVT estimates, and speed points. Compare modeled intake pressure to measured values at stable rate.</p>
          <h2>Gas and temperature effects</h2>
          <p>Free gas and elevated temperature reduce effective margin; verification should include worst credible operating cases.</p>
          <h2>Conclusion</h2>
